...
using TuraliUrunYonetimi.Models;

namespace TuraliUrunYonetimi.Controllers
{
    public class UrunsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UrunId,UrunAdi,Fiyat,StokMiktari")] Urun urun)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UrunId,UrunAdi,Fiyat,StokMiktari")] Urun urun)
        {
            if (id != urun.UrunId)
            {
                return NotFound();
